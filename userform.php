...
{
$sql="insert into userreg values('$_POST[id1]','$_POST[name1]','$_POST[address]','$_POST[email]','$_POST[phone]')";
echo $sql;
$sql1="insert into login values('$_POST[id1]','$_POST[password]','user','0','$_POST[email]')";
mysql_query($sql,$con);
...
$sql="select max(sid) as mid from userreg";
