...
<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="newsload.php">Add News</a></li>
						</ul> <!-- .menu -->
					</div> 
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:490px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:490px;overflow:hidden;">
            ...
            </div><a data-u="any" href="https://www.jssor.com" style="display:none">animation</a>
        </div>
        <!-- Bullet Navigator -->
 ...
 include('dbconnect.php');
						$sql= "select * from stationnews ORDER BY snid LIMIT 5";
           ...
           <div class="container" style="width:500px; border:1px solid #ccc;">  
                ...
                <?php  
                     ...
                     {  
                          ...
                          {  
                               echo '<label><a href="'.$row['topic'].'" target="_blank">'.$row['topic'].'</a></label>';
							   echo'<br>';
								 echo '<label><a href="'.$row['topic'].'" target="_blank">'.$row['details'].'</a></label>';
								   echo'<br>';
								   echo'<br>';
								   echo'<br>';
                          }  
